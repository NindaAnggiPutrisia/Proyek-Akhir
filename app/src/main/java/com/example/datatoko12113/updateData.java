...
class updateData extends AppCompatActivity {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isEmpty(cekNama) || isEmpty(cekJenis) || isEmpty(cekKondisi) || isEmpty(cekHrgbeli) || isEmpty(cekHrgjual)){
                    ...
                    data_toko setToko = new data_toko();
                    setToko.setNama(namaBaru.getText().toString());
                    setToko.setJenis(jenisBaru.getText().toString());
                    setToko.setKondisi(kondisiBaru.getText().toString());
                    setToko.setHrg_beli(hrgbeliBaru.getText().toString());
                    setToko.setHrg_jual(hrgjualBaru.getText().toString());
                    updateToko(setToko);
                }
            }
        });
    ...
    private void updateToko(data_toko toko){
